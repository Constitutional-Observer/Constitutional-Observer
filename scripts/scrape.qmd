...
# correct and match speakers in the dataset
sabha = Dataset.load_from_disk("./data/sabha/sabha-embeddings-english-3/").to_pandas()
...
Dataset.from_pandas(sabha).save_to_disk("data/sabha/sabha-embeddings-english-4")
```
...
ca = Dataset.load_from_disk(
    "./data/constituent-assembly/debates-embeddings"
).to_pandas()

ca.drop(columns=["__index_level_0__"], inplace=True)

ca["content"] = ca["content"].apply(lambda x: sanitizer.sanitize(x))
